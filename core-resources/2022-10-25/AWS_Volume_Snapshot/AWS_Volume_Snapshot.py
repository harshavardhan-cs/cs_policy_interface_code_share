...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    for volume in response["Volumes"]:
        if volume.get("SnapshotId"):
            evaluations.append(build_evaluation(volume["VolumeId"], 'COMPLIANT', event,annotation=''))
        else:
            evaluations.append(build_evaluation(volume["VolumeId"], 'NON_COMPLIANT', event,annotation=''))
    return evaluations
